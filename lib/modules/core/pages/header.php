...
?>
<!--[if lt IE 9]>
    <script src="<?php print $page->getCDN()?>js/core/jquery-1.10.2.min.js"></script>
    <script src="<?php print $page->getCDN()?>js/core/html5shiv.js"></script>
    <script src="<?php print $page->getCDN()?>js/core/respond.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/all.js#xfbml=1&appId=244446599054335";
