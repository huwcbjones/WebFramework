<div class="row pane" id="header">
  <div class="col-xs-12">
    <h1 class="page-header">Installing Module</h1>
    ...
    <p class="text-muted" id="status_txt">Connecting to installer...</p>
    <p class="text-muted" id="close_txt">Do not close this page until the installation finishes.</p>
  </div>
</div>
