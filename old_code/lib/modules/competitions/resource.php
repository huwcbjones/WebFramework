<?php
/**
 * Competitions Resource Class
 *
 * @category   Module.Competitions.Resource
...
class CompetitionsResource extends BaseResource
{
	const	name_space	= 'Module.Competitions.Resource';
	const	version		= '1.0.0';
